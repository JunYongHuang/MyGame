    ...
    public class XLua_Gen_Initer_Register__
	{
	    static XLua_Gen_Initer_Register__()
        {
		    XLua.LuaEnv.AddIniter((luaenv, translator) => {
				...
				translator.DelayWrapLoader(typeof(XLuaTest2.Pedding), XLuaTest2PeddingWrap.__Register);
				
				translator.DelayWrapLoader(typeof(XLuaTest2.MyStruct), XLuaTest2MyStructWrap.__Register);
				
				translator.DelayWrapLoader(typeof(XLuaTest2.MyEnum), XLuaTest2MyEnumWrap.__Register);
				
				translator.DelayWrapLoader(typeof(XLuaTest2.NoGc), XLuaTest2NoGcWrap.__Register);
				...
				translator.AddInterfaceBridgeCreator(typeof(IEasyBaseMediator), IEasyBaseMediatorBridge.__Create);
				
				translator.AddInterfaceBridgeCreator(typeof(InvokeLua.ICalc), InvokeLuaICalcBridge.__Create);
				
				translator.AddInterfaceBridgeCreator(typeof(XLuaTest2.IExchanger), XLuaTest2IExchangerBridge.__Create);
