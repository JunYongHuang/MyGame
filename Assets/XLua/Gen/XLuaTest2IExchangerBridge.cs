...
{
    public class XLuaTest2IExchangerBridge : LuaBase, XLuaTest2.IExchanger
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new XLuaTest2IExchangerBridge(reference, luaenv);
		}
		
		public XLuaTest2IExchangerBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
