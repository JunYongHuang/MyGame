...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderXLuaTest2Pedding
        {
            static IniterAdderXLuaTest2Pedding()
            {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<XLuaTest2.Pedding>(translator.PushXLuaTest2Pedding, translator.Get, translator.UpdateXLuaTest2Pedding);
				translator.RegisterPushAndGetAndUpdate<XLuaTest2.MyStruct>(translator.PushXLuaTest2MyStruct, translator.Get, translator.UpdateXLuaTest2MyStruct);
				...
				translator.RegisterPushAndGetAndUpdate<XLuaTest2.MyEnum>(translator.PushXLuaTest2MyEnum, translator.Get, translator.UpdateXLuaTest2MyEnum);
        ...
        static IniterAdderXLuaTest2Pedding s_IniterAdderXLuaTest2Pedding_dumb_obj = new IniterAdderXLuaTest2Pedding();
        static IniterAdderXLuaTest2Pedding IniterAdderXLuaTest2Pedding_dumb_obj {get{return s_IniterAdderXLuaTest2Pedding_dumb_obj;}}
        
        
        int XLuaTest2Pedding_TypeID = -1;
        public void PushXLuaTest2Pedding(RealStatePtr L, XLuaTest2.Pedding val)
        {
            if (XLuaTest2Pedding_TypeID == -1)
            {
			    bool is_first;
                XLuaTest2Pedding_TypeID = getTypeId(L, typeof(XLuaTest2.Pedding), out is_first);
				
            }
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 1, XLuaTest2Pedding_TypeID);
            if (!CopyByValue.Pack(buff, 0, val))
            {
                throw new Exception("pack fail fail for XLuaTest2.Pedding ,value="+val);
            }
			
        }
		
        public void Get(RealStatePtr L, int index, out XLuaTest2.Pedding val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != XLuaTest2Pedding_TypeID)
				{
				    throw new Exception("invalid userdata for XLuaTest2.Pedding");
				}
				
                IntPtr buff = LuaAPI.lua_touserdata(L, index);if (!CopyByValue.UnPack(buff, 0, out val))
                {
                    throw new Exception("unpack fail for XLuaTest2.Pedding");
                }
            }
            ...
            {
                val = (XLuaTest2.Pedding)objectCasters.GetCaster(typeof(XLuaTest2.Pedding))(L, index, null);
            }
        }
		
        public void UpdateXLuaTest2Pedding(RealStatePtr L, int index, XLuaTest2.Pedding val)
        {
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  val))
                {
                    throw new Exception("pack fail for XLuaTest2.Pedding ,value="+val);
                }
            }
            else
            {
        ...
        int XLuaTest2MyStruct_TypeID = -1;
        public void PushXLuaTest2MyStruct(RealStatePtr L, XLuaTest2.MyStruct val)
        {
            if (XLuaTest2MyStruct_TypeID == -1)
            {
			    bool is_first;
                XLuaTest2MyStruct_TypeID = getTypeId(L, typeof(XLuaTest2.MyStruct), out is_first);
				
            }
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 25, XLuaTest2MyStruct_TypeID);
            if (!CopyByValue.Pack(buff, 0, val))
            {
                throw new Exception("pack fail fail for XLuaTest2.MyStruct ,value="+val);
            }
			
        }
		
        public void Get(RealStatePtr L, int index, out XLuaTest2.MyStruct val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != XLuaTest2MyStruct_TypeID)
				{
				    throw new Exception("invalid userdata for XLuaTest2.MyStruct");
				}
				
                IntPtr buff = LuaAPI.lua_touserdata(L, index);if (!CopyByValue.UnPack(buff, 0, out val))
                {
                    throw new Exception("unpack fail for XLuaTest2.MyStruct");
                }
            }
			else if (type ==LuaTypes.LUA_TTABLE)
			{
            ...
            {
                val = (XLuaTest2.MyStruct)objectCasters.GetCaster(typeof(XLuaTest2.MyStruct))(L, index, null);
            }
        }
		
        public void UpdateXLuaTest2MyStruct(RealStatePtr L, int index, XLuaTest2.MyStruct val)
        {
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != XLuaTest2MyStruct_TypeID)
                ...
                if (!CopyByValue.Pack(buff, 0,  val))
                {
                    throw new Exception("pack fail for XLuaTest2.MyStruct ,value="+val);
                }
            }
            else
            {
        ...
        int XLuaTest2MyEnum_TypeID = -1;
		int XLuaTest2MyEnum_EnumRef = -1;
        
        public void PushXLuaTest2MyEnum(RealStatePtr L, XLuaTest2.MyEnum val)
        {
            if (XLuaTest2MyEnum_TypeID == -1)
            {
			    bool is_first;
                XLuaTest2MyEnum_TypeID = getTypeId(L, typeof(XLuaTest2.MyEnum), out is_first);
				
				if (XLuaTest2MyEnum_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(XLuaTest2.MyEnum));
				    XLuaTest2MyEnum_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, XLuaTest2MyEnum_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, XLuaTest2MyEnum_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for XLuaTest2.MyEnum ,value="+val);
            }
			
			LuaAPI.lua_getref(L, XLuaTest2MyEnum_EnumRef);
        ...
        public void Get(RealStatePtr L, int index, out XLuaTest2.MyEnum val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != XLuaTest2MyEnum_TypeID)
				{
				    throw new Exception("invalid userdata for XLuaTest2.MyEnum");
				}
                ...
                {
                    throw new Exception("unpack fail for XLuaTest2.MyEnum");
                }
				val = (XLuaTest2.MyEnum)e;
                
            }
            else
            {
                val = (XLuaTest2.MyEnum)objectCasters.GetCaster(typeof(XLuaTest2.MyEnum))(L, index, null);
            }
        }
		
        public void UpdateXLuaTest2MyEnum(RealStatePtr L, int index, XLuaTest2.MyEnum val)
        {
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != XLuaTest2MyEnum_TypeID)
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for XLuaTest2.MyEnum ,value="+val);
                }
            }
            else
            {
	...
	public partial class StaticLuaCallbacks
    {
	    static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			if (type == typeof(XLuaTest2.Pedding[]))
			{
			    XLuaTest2.Pedding[] array = obj as XLuaTest2.Pedding[];
				translator.PushXLuaTest2Pedding(L, array[index]);
				return true;
			}
			else if (type == typeof(XLuaTest2.MyStruct[]))
			{
			    XLuaTest2.MyStruct[] array = obj as XLuaTest2.MyStruct[];
				translator.PushXLuaTest2MyStruct(L, array[index]);
				return true;
			}
			...
			else if (type == typeof(XLuaTest2.MyEnum[]))
			{
			    XLuaTest2.MyEnum[] array = obj as XLuaTest2.MyEnum[];
				translator.PushXLuaTest2MyEnum(L, array[index]);
				return true;
			}
