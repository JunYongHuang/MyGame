...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaTest2NoGcWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(XLuaTest2.NoGc), L, translator, 0, 5, 5, 5);
			...
			Utils.EndObjectRegister(typeof(XLuaTest2.NoGc), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(XLuaTest2.NoGc), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(XLuaTest2.NoGc));
			
			
			Utils.EndClassRegister(typeof(XLuaTest2.NoGc), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					XLuaTest2.NoGc __cl_gen_ret = new XLuaTest2.NoGc();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XLuaTest2.NoGc constructor!");
        ...
        static int _m_FloatParamMethod(RealStatePtr L)
        {
            ...
            XLuaTest2.NoGc __cl_gen_to_be_invoked = (XLuaTest2.NoGc)translator.FastGetCSObj(L, 1);
        ...
        static int _m_StructParamMethod(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    XLuaTest2.MyStruct p;translator.Get(L, 2, out p);
                    
                        XLuaTest2.MyStruct __cl_gen_ret = __cl_gen_to_be_invoked.StructParamMethod( p );
        ...
        static int _m_EnumParamMethod(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    XLuaTest2.MyEnum p;translator.Get(L, 2, out p);
                    
                        XLuaTest2.MyEnum __cl_gen_ret = __cl_gen_to_be_invoked.EnumParamMethod( p );
                        translator.PushXLuaTest2MyEnum(L, __cl_gen_ret);
        ...
        static int _s_set_a3(RealStatePtr L)
        {
            ...
            try {
                ...
                XLuaTest2.NoGc __cl_gen_to_be_invoked = (XLuaTest2.NoGc)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.a3 = (XLuaTest2.MyStruct[])translator.GetObject(L, 2, typeof(XLuaTest2.MyStruct[]));
        ...
        static int _s_set_a4(RealStatePtr L)
        {
            ...
            try {
                ...
                XLuaTest2.NoGc __cl_gen_to_be_invoked = (XLuaTest2.NoGc)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.a4 = (XLuaTest2.MyEnum[])translator.GetObject(L, 2, typeof(XLuaTest2.MyEnum[]));
