...
namespace XLua
{
    public static partial class CopyByValue
    {
		...
		public static void UnPack(ObjectTranslator translator, RealStatePtr L, int idx, out XLuaTest2.Pedding val)
		{
		    val = new XLuaTest2.Pedding();
        ...
        public static bool Pack(IntPtr buff, int offset, XLuaTest2.Pedding field)
        {
        ...
        public static bool UnPack(IntPtr buff, int offset, out XLuaTest2.Pedding field)
        {
            field = default(XLuaTest2.Pedding);
		...
		public static void UnPack(ObjectTranslator translator, RealStatePtr L, int idx, out XLuaTest2.MyStruct val)
		{
		    val = new XLuaTest2.MyStruct();
            int top = LuaAPI.lua_gettop(L);
        ...
        public static bool Pack(IntPtr buff, int offset, XLuaTest2.MyStruct field)
        {
        ...
        public static bool UnPack(IntPtr buff, int offset, out XLuaTest2.MyStruct field)
        {
            field = default(XLuaTest2.MyStruct);
